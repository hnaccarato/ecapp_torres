                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="unidad_id" id="unidad_id" required="required">
                                        ...
                                        <?php foreach ($unidades->result() as $unidades) {?>
                                            <option value="<?=$unidades->id?>" <?=($unidades->id == $cuenta->unidad_id)? "selected" : "" ?>>
                            ...
                            <div class="col-xs-12 col-sm-4">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <?php if(!empty($cuenta->file_1)){?>
                                            <a href="<?=base_url('upload/cuenta_corriente/'.$cuenta->file_1)?>">
                                                <span class="glyphicon glyphicon-save-file">Recibo</span>
                                            </a>
                                        <?php } ?>
                                    </div>
                                </div>
                            ...
                            <div class="col-xs-12 col-sm-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <?php if(!empty($cuenta->file_2)){?>
                                            <a href="<?=base_url('upload/cuenta_corriente/'.$cuenta->file_2)?>">
                                                <span class="glyphicon glyphicon-save-file">Cuenta corriente</span>
                                            </a>
                                        <?php } ?>
                                    </div>
                                </div>
