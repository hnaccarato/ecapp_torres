<div class="container-fluid">
    <div class="row">
        <div class="col-xs-12 col-sm-12">
            <h2 class="mc-page-header">Cuentas corrientes y recibos</h2>
        </div>
    </div>
    ...
    <div class="row">  
        ...
        <div class="col-xs-12 col-sm-3">
            <ul class="mc-page-actions">
                <li><a type="button" href="<?=base_url();?>administrador/cuenta_corriente_create" title="Crear Nueva"><i class="fa fa-plus"></i></a></li>
            </ul>
        </div>
...
<script type="text/javascript">
    ...
    var admin = new MCAdmin({
        ...
        url: '<?=base_url();?>administrador/cuenta_corriente_read',
        table: 'unidades'
    });
    ...
    $(document).ready(function (){
      ...
      /*  $('body').on('click','.delete',function (e){
            ...
            if(window.confirm('Are you sure?')){
                location.href = '<?=base_url();?>administrador/cuenta_corriente_delete/' + primary_key_value
            }
        });*/
