    ...
    <div class="row">      
        ...
        <div class="col-xs-12 col-sm-3">
            <ul class="mc-page-actions">
                <li><a type="button" href="<?=base_url();?>administrador/propuestas_create" title="Crear Nueva"><i class="fa fa-plus"></i></a></li>
                <li><a type="button" href="javascript:void(0)" id="export-view" title="Exportar vista"><i class="fa fa-table"></i></a></li>
                <li><a type="button" href="<?=base_url();?>administrador/propuestas_excel" title="Exportar Todo"><i class="fa fa-file-excel-o"></i></a></li>
            </ul>
        </div>
        <div class="col-xs-12">
           <!--
           <ul class="nav nav-tabs" id="tabEstados">
                <?php foreach ($estados->result() as $estado){ ?>
                    <li class="estados <?=($estado->id == ACTIVO)? "active":""?>"   data-id="<?=$estado->id?>">
...
<script type="text/javascript">
    ...
    var admin = new MCAdmin({
        ...
        url: '<?=base_url();?>administrador/propuestas_read',
        table: 'propuestas'
    });
    var elemento = "la Propuesta"; 
    $(document).ready(function (){
       ...
       /* $('.delete').click(function (e){
            ...
            if(window.confirm('Are you sure?')){
                location.href = '<?=base_url();?>administrador/propuestas_delete/' + primary_key_value
            }
        });*/
        ...
        $('#export-view').click(function(){
            document.location = '<?=base_url();?>administrador/propuestas_excel' + admin.filters_url();
        });
        ...
        $(document).on( 'click', '.estados', function() {
            ...
            $("#tabEstados").children('li').removeClass('active');
