    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-3">
            <ul class="mc-page-actions">
                <li><a type="button" href="<?=base_url();?>administrador/inquilinos_create/<?=$user_id?>" title="Crear Nueva"><i class="fa fa-plus"></i></a></li>
                <li>
...
<script type="text/javascript">
    ...
    var admin = new MCAdmin({
        ...
        url: '<?=base_url("administrador/inquilinos_read/".$user_id)?>',
        table: 'users_unidad'
    });
    var elemento = "inquilino";
    $(document).ready(function (){
        ...
        $('#export-view').click(function(){
            document.location = '<?=base_url();?>administrador/inquilinos_excel' + admin.filters_url();
        });
