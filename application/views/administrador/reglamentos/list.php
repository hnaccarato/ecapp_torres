<div class="container-fluid">
    <div class="row">
        <div class="col-xs-12 col-sm-3">
            <h2 class="mc-page-header">Reglamentos</h2>
        </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-3">
            <ul class="mc-page-actions">
                <li><a type="button" href="<?=base_url();?>administrador/Reglamentos_create" title="Crear Nueva"><i class="fa fa-plus"></i></a></li>
                <li><a type="button" href="javascript:void(0)" id="export-view" title="Exportar vista"><i class="fa fa-table"></i></a></li>
                <li><a type="button" href="<?=base_url();?>administrador/Reglamentos_excel" title="Exportar Todo"><i class="fa fa-file-excel-o"></i></a></li>
            </ul>
        </div>
        <div class="col-xs-12">
...
<script type="text/javascript">
    ...
    var admin = new MCAdmin({
        ...
        url: '<?=base_url();?>administrador/Reglamentos_read',
        table: 'Reglamentos'
    });
    
    var elemento = "el seguro"; 
    ...
    $(document).ready(function (){
       ...
       /* $('.delete').click(function (e){
            ...
            if(window.confirm('Are you sure?')){
                location.href = '<?=base_url();?>administrador/Reglamentos_delete/' + primary_key_value
            }
        });*/
        ...
        $('#export-view').click(function(){
            document.location = '<?=base_url();?>administrador/Reglamentos_excel' + admin.filters_url();
        });
