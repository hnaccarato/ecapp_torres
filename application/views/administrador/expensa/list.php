<div class="container-fluid">
    <div class="row">
        <div class="col-xs-12 col-sm-3">
            <h2 class="mc-page-header">Expensa</h2>
        </div>
    </div>
    ...
    <div class="row">  
        ...
        <div class="col-xs-12 col-sm-3">
            <ul class="mc-page-actions">
                <li><a type="button" href="<?=base_url();?>administrador/expensa_create" title="Crear Nueva"><i class="fa fa-plus"></i></a></li>
...
<script type="text/javascript">
    ...
    var admin = new MCAdmin({
        ...
        url: '<?=base_url();?>administrador/expensa_read',
        table: 'unidades'
    });
    ...
    $(document).ready(function (){
      ...
      /*  $('body').on('click','.delete',function (e){
        ...
        $('#export-view').click(function(){
            document.location = '<?=base_url();?>administrador/expensa_excel' + admin.filters_url();
        });
