<div class="container-fluid">
    <div class="row">
        <div class="col-xs-12">
            <h2 class="mc-page-header">Informes de Amenities</h2>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-3">
                     <div class="form-group">
                        <label for="espacio_id">Amenity</label>
...
<script type="text/javascript">
    ...
    var admin = new MCAdmin({
        ...
        url: '<?=base_url();?>administrador/'+metodo,
        table: 'espacios'
    });
    ...
    $(document).ready(function (){
        ...
        $('#export-view').click(function(){
            var paramenters = admin.filters_url()+'&fecha_desde='+$("#fecha_desde").val()+'&fecha_hasta='+
            $("#fecha_hasta").val()+'&espacio_id='+$("#espacio_id").val();
            document.location = '<?=base_url();?>administrador/'+metodo_excel+'/' + paramenters;
        });        

        $('#export_excel').click(function(){
            document.location = '<?=base_url();?>administrador/'+metodo_excel;
        });
        ...
        $('.selection').click(function(e){
            ...
            admin.url('<?=base_url();?>administrador/'+metodo);
