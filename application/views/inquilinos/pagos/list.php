    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-3">
            <ul class="mc-page-actions">
                ...
                <li><a type="button" href="<?=base_url();?>inquilinos/pagos_excel" title="Exportar Todo"><i class="fa fa-file-excel-o"></i></a></li>
            </ul>
        </div>
    </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="myModal">
  <div class="modal-dialog" role="document">
    ...
    <form action="<?=base_url('inquilinos/nuevos_pagos')?>" method="post" 
...
var admin = new MCAdmin({
    ...
    url: '<?=base_url();?>inquilinos/pagos_read',
    table: 'pagos_users'
});
...
$(document).ready(function (){
    ...
    $('#export-view').click(function(){
        document.location = '<?=base_url();?>inquilinos/pagos_excel' + admin.filters_url();
    });
    ...
    $('body').on('click','.view_expensa',function (e){
        ...
        $.post(base_url+'inquilinos/view_pagos/',{id:id},function(data){
    ...
    $('#estado_id').change(function(){
     ...
     $("body").on("submit","#form_expensa",function(e){
        ...
        $.ajax({
            url:  base_url+"/inquilinos/set_pago/",
            type: "post",
            dataType: "html",
            data: formData,
            cache: false,
