    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-2">
            <ul class="mc-page-actions">
                ...
                <li><a type="button" href="<?=base_url();?>inquilinos/asamblea_excel" title="Exportar Todo"><i class="fa fa-file-excel-o"></i></a></li>
            </ul>
        </div>
        <div class="col-xs-12">
            <hr>
...
var admin = new MCAdmin({
    ...
    url: '<?=base_url();?>inquilinos/asamblea_read',
    table: 'asambleas'
});
...
$(document).ready(function (){
  ...
  /*  $('.delete').click(function (e){
        ...
        if(window.confirm('Are you sure?')){
            location.href = '<?=base_url();?>inquilinos/asamblea_delete/' + primary_key_value
        }
    });*/
    ...
    $('#export-view').click(function(){
        document.location = '<?=base_url();?>inquilinos/asamblea_excel' + admin.filters_url();
    });
