...
<script type="text/javascript">
    ...
    var admin = new MCAdmin({
        ...
        order_type: 'DESC',
        order_by: 'legales.id',
        url: '<?=base_url();?>inquilinos/legales_read',
        table: 'legales'
    });
    ...
    $(document).ready(function (){
       ...
       /* $('.delete').click(function (e){
            ...
            if(window.confirm('Are you sure?')){
                location.href = '<?=base_url();?>inquilinos/legales_delete/' + primary_key_value
            }
        });*/
        ...
        $('#export-view').click(function(){
            document.location = '<?=base_url();?>inquilinos/legales_excel' + admin.filters_url();
        });
