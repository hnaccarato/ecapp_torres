        ...
        <div class="col-md-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="height: 400px !important;">
                    <div class="card">
                        <a href="<?=base_url();?>inquilinos/encargado_view/<?=$register->id;?>">
                        ...
                        <div class="card-footer">
                            <div class="icon pull-right">
                                <a href="<?=base_url();?>inquilinos/encargado_view/<?=$register->id;?>" class="btn btn-info btn-xs" title="Ver Encargado">
