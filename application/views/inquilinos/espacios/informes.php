    ...
    <div class="row">
                ...
                <div class="col-xs-12 col-sm-3">
                  <div class="form-group">
                    ...
                    <div class="input-group date">
                      ...
                      value="<?=date('Y-m-d')?>" placeholder="fecha desde" name="fecha_desde">
        ...
        <div class="col-xs-12 col-sm-3">
            <ul class="mc-page-actions">
                <li class="pull-left">
                    <a type="button" href="javascript:void(0)" id="btn-search" title="Buscar resultado">
                        <i class="fa fa-search" aria-hidden="true"></i>
                    </a>
                </li>                
                <li>
                    <a type="button" title="Exportar Todo" id="export_excel">
...
<script type="text/javascript">
    ...
    var admin = new MCAdmin({
        ...
        url: '<?=base_url();?>inquilinos/'+metodo,
        table: 'espacios'
    });
    ...
    $(document).ready(function (){
        ...
        $("body").on('click','.rechazado',function(e){ 
            e.preventDefault();
            var input = $(this);
            var url = "<?=base_url('inquilinos/espacios_active')?>"; 
        ...
        $('#export-view').click(function(){
            document.location = '<?=base_url();?>inquilinos/'+metodo_excel+'/' + admin.filters_url();
        });        

        $('#export_excel').click(function(){
            document.location = '<?=base_url();?>inquilinos/'+metodo_excel;
        });
        ...
        $('.selection').click(function(e){
            ...
            admin.url('<?=base_url();?>inquilinos/'+metodo);
            admin.config.espacio_id = $("#espacio_id").val();
            admin.config.fecha_desde = $("#fecha_desde").val();
            admin.config.fecha_hasta = $("#fecha_hasta").val();
            admin.update();
