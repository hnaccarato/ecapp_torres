        ...
        <tr>
            <td valign="top" style="padding:15.0pt 15.0pt 15.0pt 15.0pt">
                <p style="line-height:150%">
                    ...
                    <p style="line-height:150%">
                      <span style="font-size:10.5pt;line-height:150%;font-family:&quot;Helvetica&quot;,&quot;sans-serif&quot;;color:#505050"><?=$expensa->titulo?><br>
                        Fecha: <?=date('d/m/Y',strtotime($expensa->fecha))?><br>
                      </span>
                    </p>
                    <span style="font-size:10.5pt;line-height:150%;font-family:&quot;Helvetica&quot;,&quot;sans-serif&quot;;color:#505050">
                      ...
                      <?php if($expensa->file) { ?>
                         <p style="line-height:150%">
                        Descargue Liquidación haciendo click 
                         <a href="<?=base_url('upload/expensas/'.$expensa->file)?>" >Aquí</a>
                          <u></u><u></u></p>
                      <?php }?>  

                      <?php if($expensa->prorrateo) { ?>
                         <p style="line-height:150%">
                       Descargue prorrateo haciendo click 
                        <a href="<?=base_url('upload/expensas/'.$expensa->prorrateo)?>" >Aquí</a>
                         <u></u><u></u></p>
                      <?php }?> 

                      <?php if($expensa->gparticulares) { ?>
                         <p style="line-height:150%">
                        Descargue Gastos Particulares haciendo click 
                         <a href="<?=base_url('upload/expensas/'.$expensa->gparticulares)?>" >Aquí</a>
                          <u></u><u></u></p>
                      <?php }?>  

                      <?php if($expensa->anexo1) { ?>
                         <p style="line-height:150%">
                        Descargue Rendición de cuentas auditadas haciendo click 
                         <a href="<?=base_url('upload/expensas/'.$expensa->anexo1)?>" >Aquí</a>
                          <u></u><u></u></p>
                      <?php }?> 

                      <?php if($expensa->anexo2) { ?>
                         <p style="line-height:150%">
                        Descargue Estado de situación patrimonial haciendo click 
                         <a href="<?=base_url('upload/expensas/'.$expensa->anexo2)?>" >Aquí</a>
                          <u></u><u></u></p>
                      <?php }?>

                      <?php if($expensa->ebancarios) { ?>
                         <p style="line-height:150%">
                        Descargue Extracto Bancario haciendo click 
                         <a href="<?=base_url('upload/expensas/'.$expensa->ebancarios)?>" >Aquí</a>
                          <u></u><u></u>
                        </p>
                      <?php }?> 
        ...
        <tr>
            <td valign="top" style="padding:15.0pt 15.0pt 15.0pt 15.0pt">
                ...
                <div>
                    ...
                    <span style="font-size:9.0pt;line-height:150%;font-family:&quot;Helvetica&quot;,&quot;sans-serif&quot;">
                            <br>A HORA EN SU SMARTPHONE<br>
                            <a href="[APP_IOS]" title="App Store" target="https://apps.apple.com/ar/app/torres-de-buenos-aires/id6449546644">
                            ...
                            <a href="[APP_ANDROID]" title="Google Play" target="https://play.google.com/store/apps/details?id=com.torresdebuenosaires.app">
                                <span style="color:#606060;text-decoration:none">
