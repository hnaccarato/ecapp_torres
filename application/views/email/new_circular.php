        ...
        <tr>
            <td valign="top" style="padding:15.0pt 15.0pt 15.0pt 15.0pt">
                <p style="line-height:150%">
                    ...
                    <p style="line-height:150%">
                      <p style="line-height:150%">
                        <span style="font-size:10.5pt;line-height:150%;font-family:&quot;Helvetica&quot;,&quot;sans-serif&quot;;color:#505050"><?=$circular->titulo?><br>
                          Desde: <?=date('d/m/Y',strtotime($circular->fecha))?><br>
                          Hasta: <?=date('d/m/Y',strtotime($circular->fecha_envio))?>
                        </span>
                      </p>
                      <p style="line-height:150%">
                        <span style="font-size:10.5pt;line-height:150%;font-family:&quot;Helvetica&quot;,&quot;sans-serif&quot;;color:#505050">
                    ...
                    <span style="font-size:10.5pt;line-height:150%;font-family:&quot;Helvetica&quot;,&quot;sans-serif&quot;;color:#505050">
                      ...
                      Descargue archivo haciendo click 
                       <a href="<?=base_url()?>upload/circular/<?=$circular->file?>">Aquí</a>
                      <?php } ?>
                        <br>
