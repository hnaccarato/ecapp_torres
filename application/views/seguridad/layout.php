    ...
    <div id="wrapper">
        ...
        <nav class="mc-top-menu" role="navigation">
            <div class="navbar-header">
                <a class="mc-navbar-brand" href="<?=base_url();?>seguridad">
            ...
            <ul class="nav navbar-top-links navbar-right hidden-xs">
                     ...
                     <?php if($messenges->num_rows()){ ?>
                         <ul class="dropdown-menu dropdown-messages">
                             <?php foreach ($messenges->result() as $value) { ?>
                                 <li>
                                    <a href="<?=base_url('seguridad/consultas_view/'.$value->id)?>">
                                        <div>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="<?=base_url('seguridad/my_user');?>"><i class="fa fa-gear fa-plus"></i>&nbsp;Mi Perfil</a></li>
                        <li class="divider"></li>
            ...
            <div class="container-fluid"> 
                <div class="row">
                  <div class="col-xs-12">
                    ...
                    <div class="thumbnail">
                        <h4 class="title_rol">seguridad</h4>
                        <hr>
                ...
                <div class="col-xs-12">
                    <ul class="mc-table-list collapse  <?=($methode == 'espacios')? 'in':''?>" id="tables-espacios">
                        <li>
                            <a href="<?=base_url();?>seguridad/espacios_list">
                                <?=ucfirst('Listado')?>
                            </a>
                        </li>                            
                        <li>
                            <a href="<?=base_url();?>seguridad/espacios_informes">
                                <?=ucfirst('Informes')?>
                            </a>
                        </li>
                    </ul>
