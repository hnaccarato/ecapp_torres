...
<script type="text/javascript">
    ...
    $(document).ready(function (){
        ...
        $('#export-view').click(function(){
            document.location = '<?=base_url();?>seguridad/'+metodo_excel+'/' + admin.filters_url();
        });        

        $('#export_excel').click(function(){
            document.location = '<?=base_url();?>seguridad/'+metodo_excel;
        });
        ...
        $('.selection').click(function(e){
            ...
            admin.url('<?=base_url();?>seguridad/'+metodo);
