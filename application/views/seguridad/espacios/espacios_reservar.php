    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-5">
            <ul class="mc-page-actions">
                <li>
                    <a type="button" href="<?=base_url();?>seguridad/espacios_list"><i class="fa fa-arrow-circle-o-left"></i></a>
                </li>
            </ul>
        </div>
        </div>
...
$(document).ready(function(){
    ...
    $("body").on('click','.activation',function(e){ 
        ...
        var input = $(this);
        var url = "<?=base_url('seguridad/espacios_active')?>"; 
...
function load(){
    ...
    $.post(base_url+"seguridad/get_reservas",
        {
            year:year,
            month:month,
        ...
        function(data){
            ...
            acction = [
            <?php if($values->autorizacion == true){?>  
                { "button":'',
                "dataid":'id',
                "rel":'<?=APROBADO?>',
                "control":'estado_id',
                ...
                "target":'_self',
                "class":'glyphicon glyphicon-thumbs-up activation aprobado',
                "parameter":''},                                 
            <?php } ?>               
            { "button":'',
            "dataid":'id',
            ...
            "class":'glyphicon glyphicon-remove activation rechazado',
            "parameter":''}];
