<script src="<?=base_url();?>access/js/Chart.bundle.min.js"></script>
<style type="text/css">
    .data_result{
        margin-top: 3%;
    }
                  ...
                  <div class="panel-body">
                      <div class="row">
                          <div class="col-sm-12 col-md-4">
                           <p>Total de unidades : <strong><?=$unidades->num_rows()?></strong></p> 
                          </div>
                          <div class="col-sm-12 col-md-4">
                            <p>Total de votos : <strong><?=$votantes->votos?></strong></p>
                          </div>                          
                          <div class="col-sm-12 col-md-4">
                            <p>Su voto fue: <strong><?=$voto->opcion?></strong></p>
                          </div>
                      </div>
                  </div>
                  <div class="col-md-8">    
