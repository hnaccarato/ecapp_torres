...
<div class="col-xs-12">
    ...
    <div class="panel panel-default">
      <div class="panel-body">
        <form action="<?=base_url('propietarios/pagar')?>" method="post" id="my_form" >
            <hr>
            <div class="row">
                ...
                <div class="col-sm-12 col-md-5" >
                    ...
                    <hr>
                      <button type="submit" class="btn btn-primary pull-right" style="margin-top: 100px">Pagar</button>
                </div>  
            </div>
...
<script type="text/javascript">
        ...
        $('#recibos').multiSelect(
            {
              afterSelect: function(values){
                 $.post(base_url+'propietarios/load_liquidacion',{expensa_id:values},function(data){
    ...
    function load_liquidacion(){
       ...
       $.post(base_url+'propietarios/load_liquidacion',{expensa_id:expensa_id},function(data){
            var liquidaciones = JSON.parse(data);
    ...
    function calcular(){
        ...
        $.post(base_url+'propietarios/porcentaje/'+total+'/'+porcentaje , function(data){
            $("#total").html(data);  
        });
