			...
			<div class="col-xs-12 col-md-4">
				<div class="row">
				  	...
				  	<div class="col-md-4">                                            
						...
						target="_blank" id="expensa_file"><i class="glyphicon glyphicon-save-file"></i> Descargar</a>
						<?php } ?>
					</div>				  	
...
-->
			...
			<div class="col-xs-12 col-md-4">
			  	...
			  	<div class="col-md-4">                                            
					...
					target="_blank" id="expensa_file"><span class="glyphicon glyphicon-save-file"></span> Descargar</a>
					<?php } ?>
				</div>	
			</div>
		</div>
		...
		<div class="row gastos">
			...
			<?php foreach ($gastos->result() as $gasto) { 
				if($flag != $gasto->tipo_gasto_id){
					echo "<div class='col-md-12 gastos_titulo pull-left'>
					<h4><strong>".$gasto->tipo."</strong></h4>
					</div>";
				} ?>
				<div class="col-md-4">
					<div class="row">
