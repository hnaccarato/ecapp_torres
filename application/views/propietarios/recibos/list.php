        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-2">
                <ul class="mc-page-actions">
                     <li><a type="button" href="<?=base_url();?>propietarios/expensas_excel" title="Exportar Todo"><i class="fa fa-file-excel-o"></i></a></li>
                </ul>
            </div>
        </div>
        <div class="row">
...
<script type="text/javascript">
    ...
    var admin = new MCAdmin({
        ...
        order_type: 'DESC',
        order_by: 'recibos.id',
        url: '<?=base_url();?>propietarios/expensas_read',
        table: 'recibos'
    });
