...
<script type="text/javascript">
    ...
    var admin = new MCAdmin({
        ...
        url: '<?=base_url();?>propietarios/'+metodo,
        table: 'espacios'
    });
    ...
    $(document).ready(function (){
        ...
        $('#export-view').click(function(){
            document.location = '<?=base_url();?>propietarios/'+metodo_excel+'/' + admin.filters_url();
        });        

        $('#export_excel').click(function(){
            document.location = '<?=base_url();?>propietarios/'+metodo_excel;
        });
        ...
        $('.selection').click(function(e){
            ...
            admin.url('<?=base_url();?>propietarios/'+metodo);
            admin.config.espacio_id = $("#espacio_id").val();
            admin.config.fecha_desde = $("#fecha_desde").val();
            admin.config.fecha_hasta = $("#fecha_hasta").val();
            admin.update();
