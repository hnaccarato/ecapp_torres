<div class="panel panel-default">
    <div class="panel-body">
        <div class="formulario_reservas">
            ...
            <?=form_open(base_url('propietarios/reservation'), $attr) ?>
            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    <p style="margin: 9px 0 10px;">
                        ...
                        <a href="<?=base_url('propietarios/get_tyc');?>"  class="glyphicon glyphicon-save-file" aria-hidden="true"></a>
                    </p>
...
$("#desde_hora").change(onSelectChange);
    ...
    function onSelectChange(){
        ...
        // alert(hora_reserva);
          $.post(base_url+'propietarios/check_permitidos/',
