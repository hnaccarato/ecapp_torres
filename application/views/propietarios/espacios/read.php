        ...
        <div class="col-sm-6 col-md-3">
            <div class="thumbnail">
              <?php if(is_file(BASEPATH.'../upload/espacios/'.$register->foto_espacio)){?>
                ...
                <?php } ?>
              <div class="caption">
                  <h5><strong><?=$register->nombre_espacio;?></strong></h5>
                  <p><?=$register->init_hora;?> - <?=$register->fin_hora;?></p>
                  <p>
                      <a href="<?=base_url();?>propietarios/espacios_load/<?=$register->id;?>" data-primary-key="<?=$register->id;?>" class="btn btn-primary btn-xs" title="Hacer una Reserva">Reservar 
