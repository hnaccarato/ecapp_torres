...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(document).on('click',".edit",function(e){
            e.preventDefault();
            var id = $(this).data('id');
            $.post(base_url+'/propietarios/get_invitado',{id:id},function(data){
        ...
        $("body").on("submit","#infitados_form",function(e){
            ...
            $.ajax({
                url:  base_url+"propietarios/add_invitados/",
                type: "post",
                dataType: "html",
                data: formData,
                cache: false,
    ...
    function invitados(){
        ...
        $.post(base_url+"propietarios/list_invitados",
            ...
            function(data){
                ...
                acction = [{ 
                    ...
                    "link":base_url+'propietarios/delete_invitados/',  
                    "button":' Eliminar',
                    "dataid":'id',
                    "target":'_self',
