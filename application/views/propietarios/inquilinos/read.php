<table class="table mc-read-table" id="table-read">
    ...
    <tbody>
        ...
        <tr  id="<?=$register->id;?>">
            ...
            <td>
                <a href="<?=base_url('propietarios/inquilino_update/'.$register->id)?>" class="btn btn-success btn-xs view" title="Editar Inquilino" ><i class="fa fa-pencil"></i> Editar</a>

                <a href="<?=base_url();?>propietarios/inquilino_delete/<?=$register->id;?>" data-primary-key="<?=$register->id;?>" class="delete btn btn-danger btn-xs" title="Eliminar Inquilino">
