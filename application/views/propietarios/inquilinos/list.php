<div class="container-fluid">
    <div class="row">
        <div class="col-xs-12 col-sm-3">
            <h2 class="mc-page-header">Inquilinos</h2>
        </div>
        ...
        <div class="col-xs-12 col-sm-3">
            <ul class="mc-page-actions">
                <li><a type="button" href="<?=base_url();?>propietarios/inquilinos_create" title="Crear Nueva"><i class="fa fa-plus"></i></a></li>
                <li><a type="button" href="javascript:void(0)" id="export-view" title="Exportar vista"><i class="fa fa-table"></i></a></li>
                <li><a type="button" href="<?=base_url();?>propietarios/inquilinos_excel" title="Exportar Todo"><i class="fa fa-file-excel-o"></i></a></li>
            </ul>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    var admin = new MCAdmin({
        ...
        url: '<?=base_url();?>propietarios/inquilinos_read',
        table: 'users_unidad'
    });
    ...
    $(document).ready(function (){
        ...
        admin.update();
         ...
         $(document).on('click','.delete',function(e){
            ...
            var text = 'Desea eliminar el Inquilino';
        ...
        $('#export-view').click(function(){
            document.location = '<?=base_url();?>propietarios/inquilinos_excel' + admin.filters_url();
        });
