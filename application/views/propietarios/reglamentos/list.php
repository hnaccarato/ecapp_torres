    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-3">
            <ul class="mc-page-actions">
                <li><a type="button" href="<?=base_url();?>propietarios/Reglamentos_excel" title="Exportar Todo"><i class="fa fa-file-excel-o"></i></a></li>
            </ul>
        </div>
        <div class="col-xs-12">
...
<script type="text/javascript">
    ...
    var admin = new MCAdmin({
        ...
        url: '<?=base_url();?>propietarios/Reglamentos_read',
        table: 'Reglamentos'
    });
    ...
    $(document).ready(function (){
       ...
       /* $('.delete').click(function (e){
            ...
            if(window.confirm('Are you sure?')){
                location.href = '<?=base_url();?>propietarios/Reglamentos_delete/' + primary_key_value
            }
        });*/
        ...
        $('#export-view').click(function(){
            document.location = '<?=base_url();?>propietarios/Reglamentos_excel' + admin.filters_url();
        });
