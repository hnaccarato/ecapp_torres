    ...
    <div class="row">      
        ...
        <div class="col-xs-12 col-sm-3">
            <ul class="mc-page-actions">
                <li>
                    <a type="button" href="javascript:void(0)" id="export-view" title="Exportar vista">
...
<script type="text/javascript">
    ...
    var admin = new MCAdmin({
        ...
        order_type: 'DESC',
        order_by: 'legales.id',
        url: '<?=base_url();?>propietarios/legales_read',
        table: 'legales'
    });
    ...
    $(document).ready(function (){
       ...
       /* $('.delete').click(function (e){
            ...
            if(window.confirm('Are you sure?')){
                location.href = '<?=base_url();?>propietarios/legales_delete/' + primary_key_value
            }
        });*/
        ...
        $('#export-view').click(function(){
            document.location = '<?=base_url();?>propietarios/legales_excel' + admin.filters_url();
        });
