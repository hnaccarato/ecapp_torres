<div class="container-fluid">
    <div class="row">
        <div class="col-xs-12 col-sm-5">
            <h2 class="mc-page-header">Read - users</h2>
        </div>
        <div class="col-xs-12 col-sm-5">
            <div class="row">
        ...
        <div class="col-xs-12 col-sm-2">
            <ul class="mc-page-actions">
                <li><a type="button" href="<?=base_url();?>admin/users_create" title="create new"><i class="fa fa-plus"></i></a></li>
                <li><a type="button" href="javascript:void(0)" id="export-view" title="export current view"><i class="fa fa-table"></i></a></li>
                <li><a type="button" href="<?=base_url();?>admin/users_excel" title="export full table"><i class="fa fa-file-excel-o"></i></a></li>
            </ul>
        </div>
        <div class="col-xs-12">
    ...
    $(document).ready(function (){
      ...
      /*  $('.delete').click(function (e){
            ...
            if(window.confirm('Are you sure?')){
                location.href = '<?=base_url();?>admin/users_delete/' + primary_key_value
            }
        });*/
        ...
        $('#export-view').click(function(){
            document.location = '<?=base_url();?>admin/users_excel' + admin.filters_url();
        });
