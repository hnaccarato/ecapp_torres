        ...
        <tr>
            <td valign="top" style="padding:15.0pt 15.0pt 15.0pt 15.0pt">
                <p style="line-height:150%">
                    ...
                    <p>Estimad@ <?=$name?>,<br>
                    Usted fue dado de alta en el sistema de <?=$this->my_style->get_name()?>, para ingresar haga click <a href="<?=base_url().'auth/reset_password/'.$forgotten_password_code ?>">Aquí</a> y coloque su nueva contraseña.
                    </p> 
                    </span>
                </p>
            </td>
    ...
    <tbody>
        <tr>
            <td valign="top" style="padding:15.0pt 15.0pt 15.0pt 15.0pt">
                ...
                <p class="MsoNormal" align="center" style="text-align:center;line-height:150%">
                    <span style="font-size:9.0pt;line-height:150%;font-family:Helvetica">
