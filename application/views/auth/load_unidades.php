        ...
        <nav class="mc-top-menu" role="navigation">
            <div class="navbar-header">
                <a class="mc-navbar-brand" href="<?=base_url();?>">
                    <img src="<?php echo $this->my_style->get_logo()?>" class="img-responsive" 
            ...
            <div class="row" >
                <div class="col-md-12">
                    ...
                    <?php foreach ($unidades->result() as $value) {?>
                        <?php $edificio = 0 ?>
                        <?php if($edificio == $value->edificio_id){
                            $edificio = $value->edificio_id;
                        }?>
                       ...
                       <div class="panel panel-default">
                         <div class="panel-heading">
                            <h3 class="panel-title">
                                <?=$value->edificio_nombre.' -'.$value->edificio_telefono?>
                            </h3>
                         </div>
