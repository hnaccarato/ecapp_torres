...
class Googlemaps {
	...
	/*key online*/
	var $apiKey						= 'AIzaSyDjlca7c-250lMh5PgFk_xiBhU-6656kqQ'; 
	/*key localhost*/
	//var $apiKey						= 'AIzaSyCTuazTT4ftRrTOscHQYPabgJPLiBS9YXc'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
