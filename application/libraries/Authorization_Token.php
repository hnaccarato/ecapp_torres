...
class Authorization_Token 
{
    ...
    public function generateToken($data = null)
    {
        if ($data AND is_array($data))
        {
            ...
            $hora_actual = time(); // obtiene la hora actual en formato de tiempo Unix
            $hora_en_24h = strtotime('+24 hours', $hora_actual); // agrega 24 horas a la hora actual
            $data['API_TIME'] = $hora_en_24h;
