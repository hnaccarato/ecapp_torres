...
class Cors
{
    ...
    private function configureAllowedOrigin(CI_Output $response, CI_Input $request)
    {
    ...
    private function configureAllowedMethods(CI_Output $response, CI_Input $request)
    {
    ...
    private function configureAllowedHeaders(CI_Output $response, CI_Input $request)
    {
    ...
    private function configureAllowCredentials(CI_Output $response)
    {
    ...
    private function configureExposedHeaders(CI_Output $response)
    {
    ...
    private function configureMaxAge(CI_Output $response)
    {
        if ($this->maxAge !== null) {
