 ...
 */
$config['site_title']                 = "Torres de Buenos Aires";       // Site Title, example.com
$config['admin_email']                = "ecapp@torresba.com"; // Admin Email, admin@example.com
...
$config['set_password'] = 'set_password.tpl.php';
