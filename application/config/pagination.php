<?php 
	...
	$config['pagination']['next_tag_open'] = '<li class="list_pag">';
	$config['pagination']['next_tag_close'] = '</li>';
	$config['pagination']['prev_tag_open'] = '<li class="list_pag">';
	$config['pagination']['prev_tag_close'] = '</li>';
	$config['pagination']['num_tag_open'] = '<li class="list_pag">';
	...
	$config['pagination']['first_tag_open'] = '<li class="list_pag">';
	$config['pagination']['first_tag_close'] = '</li>';
	$config['pagination']['last_link'] = '››';
	$config['pagination']['last_tag_open'] = '<li class="list_pag">';
